...
# The Census API key is read from the environment rather than stored in this file.
# Request a free key at https://api.census.gov/data/key_signup.html, then add a line
# reading CENSUS_API_KEY=your_key_here to a .Renviron file in the project root.
...
```{r}
# An API key is needed to access census data through tidycensus (see setup chunk above).
